...
const drawBarChartCompression = (bins=10)=>{
...
const drawBarChartDistance = (bins=10)=>{
    ...
    d3.json('result/result.json',function(error,jsonData){
        ...
        let programs = jsonData.result;
        let distances = programs.map((item)=>{
...
window.onload = function(){
    drawLine();
    drawScatterplot();
    drawBarChartCompression(bins=10);
    drawBarChartDistance(bins=10);
