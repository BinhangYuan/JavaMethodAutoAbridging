...
export function questions(state = {questions:{},index:1,answer: "Not done!",reduction:"r50%"},action){
	switch(action.type){
		case Action.UPDATEQUESTION:
			return { ...state, questions:action.questions,index:1,answer: "Not done!",reduction:"r50%"};
