		...
		return(
			<div className="row">
				...
				<div className="col-md-8 text-justify">
					...
					<p> Our research tries to reduce source code inside Java methods so that large amounts of queried Java code can be displayed by limited space without hindering human comprehension.</p>
					...
					<ul>
  						<li>
  							...
  							Your accuracy and reacting time are the key factors in our study.
  						</li>
  						<li>
  						...
  						<li>
  							...
  							Please check each option and compare the outcome carefully. In the end, we will conduct a survey about your preferences for the reduction method and the reduced level.
  						</li>
					</ul>
					...
					<p> In the end, please click submit button. Leave after you see the message "Your answer was successfully submitted to our server!" </p>
