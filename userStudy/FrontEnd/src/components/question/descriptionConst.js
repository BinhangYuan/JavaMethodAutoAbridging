...
export const surveyConfig = [
	{
		title:"Which version of a code tended to make it easier to write your description?",
		options: ["non-reduced","reduction method A","reduction method B"]
	},
	{
		title:"Those codes reduced using reduction method A were generally the easiest to understand, at a high level.",
		options: ["agree", "neither agree nor disagree", "disagree"]
	},
	{
		title:"Those codes reduced using reduction method B were generally the easiest to understand, at a high level",
		options: ["agree", "neither agree nor disagree", "disagree"]
	},
	{
		title:"The non-reduced does were generally the easiest to understand, at a high level",
		options: ["agree", "neither agree nor disagree", "disagree"]
	},
]