          ...
          <div className="col-md-2 text-center">
            <div className="form-group">
              ...
              <div className="selectContainer">
                <select name="language" className="form-control" disabled={this.props.questions.questions[this.props.questions.index.toString()].method==="non-reduced code"} onChange={(e)=>{this.handleOptionReduction(e)}}>
